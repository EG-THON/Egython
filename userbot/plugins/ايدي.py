...
async def fetch_info(replied_user, event):
    ...
    rotbat = ".مطـور السورس ." if user_id == 1614314857 or user_id == 1290321198 or user_id == 1337732405 or user_id == 1985220043 or user_id == 1944479661 or user_id == 1441837187 or user_id == 1993573528 or user_id == 1355571767 or user_id == 1850008091 or user_id == 1933191679 or user_id == 1691343402 else (".「 العضـو 𓅫 」.") 
    rotbat = "مـالك الحساب" if user_id == (await event.client.get_me()).id and user_id != 1614314857 and user_id != 1290321198 and user_id != 1337732405 and user_id != 1985220043 and user_id != 1944479661 and user_id != 1441837187 and user_id != 1993573528 and user_id != 1355571767 and user_id != 1850008091 and user_id != 1933191679 and user_id != 1691343402 else rotbat
...
async def fetch_info(replied_user, event):
    ...
    username = "@{}".format(username) if username else ("لايوجد معرف")
    user_bio = "لاتوجد نبذه" if not user_bio else user_bio
    rotbat = "مطـور السورس" if user_id == 1614314857 or user_id == 1290321198 or user_id == 1337732405 or user_id == 1985220043 or user_id == 1944479661 or user_id == 1441837187 or user_id == 1993573528 or user_id == 1355571767 or user_id == 1850008091 or user_id == 1933191679 or user_id == 1691343402 else ("العضـو") 
    rotbat = "مـالك الحساب" if user_id == (await event.client.get_me()).id and user_id != 1614314857 and user_id != 1290321198 and user_id != 1337732405 and user_id != 1985220043 and user_id != 1944479661 and user_id != 1441837187 and user_id != 1993573528 and user_id != 1355571767 and user_id != 1850008091 and user_id != 1933191679 and user_id != 1691343402 else rotbat
    caption = f"<b> {Egy_TEXT} </b>\n"
    caption += f"<b> 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 </b>\n"
    caption += f"<b> {ZEDM}| 𝑵𝑨𝑴𝑬    » </b> {first_name} {last_name}\n"
