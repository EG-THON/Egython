...
async def variable(var):
    ...
    if exe == "جلب":
        ...
        if variable in heroku_var:
            await ics.edit("**᥀︙ تم تغيـر** `{}` **:**\n **- المتغير :** `{}` \n**- يتم الان اعـادة تشغيـل بـوت ايجيثون يستغـرق الامر 2-1 دقيقه⏳.**".format(variable, value))
        else:
        ...
        await ics.edit(f"**᥀︙** `{variable}`  **تم حذفه بنجاح. \n**يتم الان اعـادة تشغيـل بـوت ايجيثون يستغـرق الامر 2-1 دقيقه⏳.**")
