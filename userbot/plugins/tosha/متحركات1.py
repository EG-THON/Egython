...
async def tmgif(kim):
    ...
    if tm_gif:
        kim_c = f"**{TMTE}**\n"
        kim_c += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
        kim_c += f"**⌯ المتحركه الاولى .**"
...
async def tmgif(lon):
    ...
    if tm_gif2:
        ics_c = f"**{TMTE}**\n"
        ics_c += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
        ics_c += f"**⌯ المتحركه الثانيه .**"
...
async def tmgif(i):
    ...
    if tm_gif3:
        tumc = f"**{TMTE}**\n"
        tumc += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
        tumc += f"**⌯ المتحركه الثالثه .**"
