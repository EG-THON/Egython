# for -<*>~ SOURCE EGY ~<*>- edit By: @EGYTHON
...
async def kickme(leave):
    await leave.edit("◄ تم مغادره المجموعه بنجاح .")
...
async def _(event):
    if event.fwd_from:
        return
    mentions = "𝐒𝐨𝐮𝐫𝐜𝐞 𝐄𝐠𝐲𝐭𝐡𝐨𝐧 - 𝐆𝐫𝐨𝐮𝐩 𝐃𝐚𝐭𝐚.\n** ◄ المشرفـون في ۿذه المجموعه :** \n"
    reply_message = None
...
async def _(event):
    ...
    if input_str:
        ...
        if not chat.admin_rights and not chat.creator:
            await edit_or_reply(event, "**◄ انت لسته مشرف هنا .**")
            return False
    p = 0
    b = 0
    c = 0
    ...
    async for i in bot.iter_participants(event.chat_id):
        ...
        if i.bot:
            ...
            n += 1
    if input_str:
        required_string = """𝐒𝐨𝐮𝐫𝐜𝐞 𝐄𝐠𝐲𝐭𝐡𝐨𝐧 - 𝐆𝐫𝐨𝐮𝐩 𝐃𝐚𝐭𝐚.\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 
...
async def rm_deletedacc(show):
    ...
    if con != "المحذوفه":
        event = await edit_or_reply(show, "**◄ جـاري البحـث عن الحسابات المحـذوفه .**")
        async for user in show.client.iter_participants(show.chat_id):
            if user.deleted:
                del_u += 1
                await sleep(0.5)
        if del_u > 0:
            del_status = f"◄ تم العثور على**{del_u}** حساب محذوف\
                           \nللتنظيف استخدم `.تنظيف الحسابات المحذوفه` ."
...
async def fetch_info(chat, event):
    ...
    caption = "<b> 𝐒𝐨𝐮𝐫𝐜𝐞 𝐄𝐠𝐲𝐭𝐡𝐨𝐧 - 𝐆𝐫𝐨𝐮𝐩 𝐃𝐚𝐭𝐚.\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 </b>\n"
    ...
    if hasattr(chat_obj_info, "scam") and chat_obj_info.scam:
        ...
        caption = f"<b>𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐒𝐨𝐮𝐫𝐜𝐞 - [𝐋𝐢𝐧𝐤](t.me/Egython) .</b>"
    return caption
