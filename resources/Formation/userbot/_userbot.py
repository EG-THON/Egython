...
ICS_ID = ["1614314857", "5016300168"]

# for print :
usr = "Egy USERBOT -{}".format(Tlk)
adn = "Egy ADMIN TOOLS -{}".format(Tlk)
ani = "Egy ANIMATIONS -{}".format(Tlk)
tsh = "Egy TOSHA -{}".format(Tlk)
ast = "Egy ASSISTANT -{}".format(Tlk)
pmt = "Egy ASSISTANT PM -{}".format(Tlk)
