...
C = "**⌔╎المعادله ⪼** {}\n  **- الحل ⪼** {}"
Calc = (
    "𓆰 𝗦𝗢𝗨𝗥𝗖𝗘 𝐑𝐀𝐈𝐈𝐒 - 𝑪𝑨𝑳𝑪𝑼𝑳𝑨𝑻𝑶𝑹 𓆪\n"
    "◐━─━─━─━─**𝐑𝐀𝐈𝐈𝐒**─━─━─━─━◐\n"
    "**⌔╎قائـمه اوامر الحاسبه :** \n"
    "⪼ `.حاسبه` + المعادله \n"
    "◐━─━─━─━─**𝐑𝐀𝐈𝐈𝐒**─━─━─━─━◐\n"
    "𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝐑𝐀𝐈𝐈𝐒 - [𝘿𝙀𝙑](t.me/Egython) 𓆪"
)
...
⫷ @Egython - اذا كنت بحاجه الى مساعده فتوجه الى ⫸
⫷ @QQ070 - تحياتي : الريس علش ⫸"""
)
