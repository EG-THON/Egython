...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/EG-THON/EGYTHON_thon.git"
    )
    ...
    CUSTOM_ALIVE_EMEgy = os.environ.get("CUSTOM_ALIVE_EMEgy", None)
    CUSTOM_PMPERMIT = os.environ.get("CUSTOM_PMPERMIT", None)
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Egy - UserBot")
    CLEAN_WELCOME = os.environ.get("CLEAN_WELCOME", True)
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/b4a17055dafc1adfd226c.jpg"
    )
    UB_BLACK_LIST_CHAT = {
